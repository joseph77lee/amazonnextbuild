      ...
      <div className="flex items-center px-2 gap-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center justify-between mt-1 border border-gray-300 px-4 py-1 rounded-full w-28 shadow-log shadow-gray-300">
              <span
                onClick={() =>
                  dispatch(
                    decreaseQuantity({
        ...
        <div className="text-lg font-semibold text-amzon_blue">
